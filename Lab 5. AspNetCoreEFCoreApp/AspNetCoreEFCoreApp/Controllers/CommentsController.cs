...
namespace AspNetCoreEFCoreApp.Controllers
{
    public class CommentsController : Controller
    {
        ...
        {
            var bloggingContext = _context.Comments.Include(c => c.Post);
        ...
        public async Task<IActionResult> Create([Bind("CommentId,Content,Date,PostId")] Comment comment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CommentId,Content,Date,PostId")] Comment comment)
        {
